const DATA = [{
    question: 'Если у тебя есть 3 конфеты, и ты дал 1 конфету другу, сколько у тебя осталось конфет',
    answers: [{
            id: '1',
            value: '2',
            correct: true,
...
{
    question: 'Если у тебя 5 мячиков и ты отдашь 2 мячика другу, сколько у тебя останется мячиков',
    answers: [{
            id: '4',
            value: '2',
            correct: false,
...
{
    question: 'Если у тебя 4 карандаша и ты отдашь 1 карандаш другу, сколько у тебя останется карандашей',
    answers: [{
            id: '7',
            value: '2',
            correct: false,
...
if (checkAnswers()) {
    ...
    // Устанавливаем куки
    setCookie('levelPassedOne', 'true', 1); 
} else {
