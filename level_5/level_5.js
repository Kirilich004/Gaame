const DATA = [{
    question: 'Какой цвет получается, если смешать желтый и синий',
    answers: [{
            id: '1',
            value: 'Зеленый',
            correct: true,
...
{
    question: 'Какой инструмент мы обычно используем для рисования',
    answers: [{
            id: '4',
            value: 'Ложка',
            correct: false,
...
{
    question: 'Что подойдет художнику',
    answers: [{
            id: '7',
            value: 'Каска',
            correct: false,
...
if (checkAnswers()) {
    ...
    // Устанавливаем куки
    setCookie('levelPassedFive', 'true', 1); 
} else {
